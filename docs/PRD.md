...
> **Tag structure details:** See [PRD: Fact Metadata and Tagging System (#18)](https://github.com/ametku/team-memory/issues/18) for the full tagging design — hybrid category taxonomy + freeform keyword tags.
